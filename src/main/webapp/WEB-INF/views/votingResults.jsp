...
<div class="container">
            ...
            <div class="card-body">
                <ul class="results-list">
                    <c:forEach var="entry" items="${results}">
                        <li>
                            <span class="candidate-name"><c:out value="${entry.key.name}"/></span>
    ...
    <br/>
    <a href="${pageContext.request.contextPath}/votings/<c:out value="${votingId}"/>" class="btn">Back to Voting Details</a>
