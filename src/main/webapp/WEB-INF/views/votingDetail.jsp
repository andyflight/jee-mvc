    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="voting-details">
                ...
                <!-- Status indicator with conditional formatting using JSTL if -->
            ...
            <!-- Using JSTL choose/when for different styles based on isActive -->
            <c:choose>
                <c:when test="${voting.isActive}">
                    <!-- Voting Form (shown only if active) -->
                    <div class="voting-form">
                        ...
                        <form action="${pageContext.request.contextPath}/vote" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Using JSTL forEach for candidates list -->
